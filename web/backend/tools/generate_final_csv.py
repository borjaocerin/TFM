#!/usr/bin/env python
"""
Script para generar dataset procesado (alternativa)
"""
import pandas as pd
...
OUT_CSV = repo_root / "data" / "out" / "laliga_enriched_final.csv"
...
def main():
    ...
    # El CSV está en formato team-vs-opponent
    # Transformar a formato partido único si es necesario
    if 'team' in df.columns and 'opponent' in df.columns:
        print("Convertiendo de formato team-opponent a formato partido único...")
